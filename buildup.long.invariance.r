...
R3TPLBS ~~ KR4TPLBS
'
fit11 <- cfa(long.invar11, missing = "FIML", estimator = "MLR", data = FACES2006.subset, std.lv=TRUE) 
summary(fit11, fit.measures = TRUE, rsquare = TRUE, standardized = TRUE)
inspect(fit11, "cov.lv") 
inspect(fit11, "cov.ov") # always good to look for negatives
#--------------------------------------------------------
# AtL(PLBS) + COG + PROB
long.invar10.b <- '
cog1 =~ A1PPVT4W + A1WJAPW + A1WJLWW
...
R3MOTIVE ~~ KR4MOTIV
'
fit10.b <- cfa(long.invar10.b, missing = "FIML", estimator = "MLR", data = FACES2006.subset, std.lv=TRUE) 
summary(fit10.b, fit.measures = TRUE, rsquare = TRUE, standardized = TRUE)
inspect(fit10.b, "cov.lv") 
inspect(fit10.b, "cov.ov") # always good to look for negatives
